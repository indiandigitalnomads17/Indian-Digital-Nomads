    ...
    colors: {
        primary: {
            root: [
                ...
                // Icon styles
                "*:data-icon:text-white/70 hover:*:data-icon:text-white/90",
            ].join(" "),
        },
        secondary: {
            root: [
                "bg-brand-secondary text-white shadow-xs-skeuomorphic ring-1 ring-brand-secondary ring-inset hover:bg-brand-secondary_hover data-loading:bg-brand-secondary_hover",
                // Icon styles
                "*:data-icon:text-white/70 hover:*:data-icon:text-white/90",
            ].join(" "),
        },
        tertiary: {
            root: [
                "text-slate-600 hover:bg-brand-solid hover:text-white data-loading:bg-primary_hover transition-colors",
                // Icon styles
                "*:data-icon:text-slate-400 hover:*:data-icon:text-white",
            ].join(" "),
        },
        "link-color": {
            root: [
