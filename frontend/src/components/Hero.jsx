    ...
    <section className="relative pt-40 pb-32 px-8 max-w-7xl mx-auto overflow-visible flex flex-col items-center justify-center min-h-[80vh]">
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-4xl mx-auto mt-8">
        ...
        <p className="text-xl md:text-2xl text-[#64748B] max-w-2xl mb-16 leading-relaxed">
          ...
          Empowering small businesses with the energy of the next generation.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-8 w-full max-w-3xl justify-center">
          ...
          <BorderGlow
            ...
            borderRadius={24}
          >
            <h3 className="font-headline text-2xl font-bold mb-2 text-[#0B1C30]">
              I am a Business Owner
            </h3>
            <p className="text-[#64748B] mb-8 text-sm">
              Post a gig and find talent in minutes.
            </p>
            <AnimatedBtn1
              className="mt-auto shadow-lg shadow-green-500/20 w-full"
              color1="#1ab854ff"
              color2="#15803d"
              hoverColor1="#15803d"
              hoverColor2="#166534"
          ...
          >
            ...
            <p className="text-[#64748B] mb-8 text-sm">
              Monetize your skills locally today.
            </p>
            <AnimatedBtn1
              className="mt-auto shadow-lg shadow-blue-500/20 w-full"
              color1="#3b82f6"
              color2="#2563EB"
              hoverColor1="#2563EB"
              hoverColor2="#1d4ed8"
