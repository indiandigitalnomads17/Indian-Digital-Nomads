        ...
        <AriaDialogTrigger>
            <header className="flex h-14 items-center justify-between border-b border-slate-200 bg-white p-3 pl-4 lg:hidden">
                ...
                <AriaButton
                    ...
                    className="group flex items-center justify-center rounded-lg bg-white p-2 text-slate-600 outline-focus-ring hover:bg-slate-50 hover:text-slate-900 focus-visible:outline-2 focus-visible:outline-offset-2"
                >
